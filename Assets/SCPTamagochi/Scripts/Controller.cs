...
public class Controller : MonoBehaviour
{
    ...
    private void Awake()
    {
        contactTest = new Test("Êîíòàêò", new List<int>(new int[] { 1, 2, 3, 4 }));
        EldrichKnowledge = new KPoint("Äðåâíèå", AnomalyInfo.INFO.ELDRICH);
        FleshKnowledge = new KPoint("Ïëîòü", AnomalyInfo.INFO.FLESH);
        MechKnowledge = new KPoint("Ìåõàí", AnomalyInfo.INFO.MECH);
